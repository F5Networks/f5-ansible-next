...
options:
  ...
  instance:
    ...
    suboptions:
      ...
      ha_dp_vlan_tag:
        description:
          - The vlan tag for data plane vlan, must be one of the IDs specified by C(vlans) parameter.
          - When provided this parameter requires C(ha_dp_vlan_name) to be
            defined.
        type: int
      ha_cp_vlan_tag:
        description:
          - The vlan tag for control plane vlan, must be one of the IDs specified by C(vlans) parameter.
          - When provided this parameter requires C(ha_cp_vlan_name) to be
            defined.
        type: int
      external_vlan_name:
        description:
      ...
      external_vlan_tag:
        description:
          - The vlan tag for external vlan, must be one of the IDs specified by C(vlans) parameter.
          - When provided this parameter requires C(external_vlan_name) to be
            defined.
        type: int
      internal_vlan_tag:
        description:
          - The vlan tag for internal vlan, must be one of the IDs specified by C(vlans) parameter.
...
from ..module_utils.templates.deploy import rseries
...
class ModuleParameters(Parameters):
    ...
    def provider_type(self):
        result = self._values['provider'].get('type')
        if result:
            return result.upper()

    @property
    def image_name(self):
        return self._values['provider'].get('image_name')
    ...
    @property
    def disk_size(self):
        return self._values['instance'].get('disk_size')
    ...
    @property
    def vlans(self):
        return self._values['instance'].get('vlans')
    ...
    @property
    def ha_dp_vlan_name(self):
        return self._values['instance'].get('ha_dp_vlan_name')

    @property
    def ha_cp_vlan_name(self):
        return self._values['instance'].get('ha_cp_vlan_name')

    @property
    def ha_dp_vlan_tag(self):
        return self._values['instance'].get('ha_dp_vlan_tag')

    @property
    def ha_cp_vlan_tag(self):
        return self._values['instance'].get('ha_cp_vlan_tag')
...
class ModuleManager(object):
    ...
    def provider_exists(self):
        query = f"?filter=name+eq+'{self.want.provider_name}'+and+type+eq+'{self.want.provider_type}'"
    ...
    def deploy_on_device(self):
        ...
        output = process_json(params, rseries)
        ...
        argument_spec = dict(
            ...
            instance=dict(
                ...
                options=dict(
                    ...
                    ha_dp_vlan_name=dict(),
                    ha_cp_vlan_name=dict(),
                    ha_dp_vlan_tag=dict(type='int'),
                    ha_cp_vlan_tag=dict(type='int'),
                ...
                required_by={
                    'ha_dp_vlan_tag': 'ha_dp_vlan_name',
                    'ha_cp_vlan_tag': 'ha_cp_vlan_name',
